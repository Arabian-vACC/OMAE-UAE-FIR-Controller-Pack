...
def main():
    ...
    targets = [
        ('CTA', 'OMAE/Plugins/TopSky/TopSky CTA/TopSkyFAST.txt'),
        ('CTA Abu Dhabi', 'OMAE/Plugins/TopSky/TopSky CTA Abu Dhabi/TopSkyFAST.txt'),
        ('CTA Dubai', 'OMAE/Plugins/TopSky/TopSky CTA Dubai/TopSkyFAST.txt'),
        ('Enroute', 'OMAE/Plugins/TopSky/TopSky Enroute/TopSkyFAST.txt'),
    ]
